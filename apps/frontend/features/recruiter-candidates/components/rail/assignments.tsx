...
export function CandidateAssignments({ candidate }: { candidate: RecruiterCandidate }) {
          ...
          <div className="flex items-center justify-between group">
            <div className="flex items-center gap-2 text-sm">
              ...
              <div>
                ...
                <span className="text-xs text-[hsl(var(--muted-foreground))]">Primary Recruiter</span>
              </div>
            </div>
